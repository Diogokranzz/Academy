      ...
      <div className="w-full rounded-3xl px-2 sm:px-8 py-14 bg-gradient-to-br from-blue-50 to-gray-50 dark:from-gray-900 dark:to-gray-800 flex flex-col" style={{ background: 'linear-gradient(135deg, rgba(59, 130, 246, 0.15), rgba(96, 165, 250, 0.1)), url(https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=1200&q=80) center/cover' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-7">
          ...
          <div className="rounded-2xl bg-white/20 backdrop-blur-sm p-7 flex flex-col gap-4 border border-white/30">
            ...
            <div className="text-gray-300 text-sm">Posts de treinos, PRs e fotos com comentários, reações e compartilhamento instantâneo.</div>
            <div className="font-semibold text-white mt-4">Match de treino</div>
            <div className="text-gray-300 text-sm">Encontre parceiros por proximidade, objetivos e disponibilidade com chat E2E.</div>
            <div className="font-semibold text-white mt-4">Gamificação</div>
            <div className="text-gray-300 text-sm">Badges, streaks, desafios mensais e leaderboards por cidade, academia e amigos.</div>
          </div>
          <div className="rounded-2xl bg-white/20 backdrop-blur-sm p-7 border border-white/30">
            ...
            <div className="flex flex-col gap-2">
              <div className="bg-gray-700/80 backdrop-blur-sm rounded-xl p-3 text-sm text-white flex justify-between border border-gray-600/50"><span>100 treinos</span><span>Badge lendária + XP + doação solidária</span></div>
              <div className="bg-gray-700/80 backdrop-blur-sm rounded-xl p-3 text-sm text-white flex justify-between border border-gray-600/50"><span>1000 km</span><span>Badge lendária + XP + doação solidária</span></div>
              <div className="bg-gray-700/80 backdrop-blur-sm rounded-xl p-3 text-sm text-white flex justify-between border border-gray-600/50"><span>Streak 30 dias</span><span>Badge lendária + XP + doação solidária</span></div>
            </div>
          </div>
        </div>
      </div>
