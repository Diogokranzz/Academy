      ...
      <div className="w-full rounded-3xl px-2 sm:px-8 py-14 bg-gradient-to-br from-blue-50 to-gray-50 dark:from-gray-900 dark:to-gray-800 flex flex-col" style={{ background: 'linear-gradient(135deg, rgba(59, 130, 246, 0.15), rgba(96, 165, 250, 0.1)), url(https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=1200&q=80) center/cover' }}>
        ...
        <div className="flex flex-col lg:flex-row gap-10 mt-6">
          ...
          <div className="flex-1 flex flex-col gap-6 max-w-[430px] mx-auto">
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-7 flex flex-col gap-3 border border-gray-600/50">
              <div className="text-blue-300 text-[15px] font-semibold">Scanner inteligente</div>
              <div className="text-gray-100/90 text-[15px]">Código de barras + IA generativa para fotos de prato com estimativa de macros e porções.</div>
            </div>
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-7 flex flex-col gap-3 border border-gray-600/50">
              <div className="text-blue-300 text-[15px] font-semibold">Planos personalizados</div>
              <div className="text-gray-100/90 text-[15px]">Sugestões de refeições alinhadas ao objetivo calórico, restrições e disponibilidade local.</div>
            </div>
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-7 flex flex-col gap-3 border border-gray-600/50">
              <div className="text-blue-300 text-[15px] font-semibold">Integrações externas</div>
              <div className="text-gray-100/90 text-[15px]">Nutritionix, restaurantes parceiros e lembretes de hidratação com insights semanais.</div>
            </div>
          </div>
        </div>
      </div>
