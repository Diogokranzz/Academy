        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mt-2">
          <div className="lg:col-span-3 flex flex-col gap-6">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-5 flex flex-col gap-y-2 items-center justify-center text-center min-h-[120px] border border-white/30">
              <div className="text-blue-200 text-sm font-semibold">CHECK-IN</div>
              <div className="text-white font-bold">QR Code ou geofencing automático</div>
              <div className="text-white/90 text-xs">Usuário recebe confirmação instantânea, compartilhamento com amigos e desbloqueio de badges.</div>
            </div>
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-5 flex flex-col gap-y-2 items-center justify-center text-center min-h-[120px] border border-white/30">
              <div className="text-blue-200 text-sm font-semibold">INSIGHTS</div>
              <div className="text-white font-bold">Heatmap comunitário</div>
              <div className="text-white/90 text-xs">Veja hotspots por horário, classes mais buscadas e rotas preferidas da comunidade.</div>
            </div>
            </div>
          </div>
          <div className="lg:col-span-2 flex flex-col gap-6">
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-7 flex flex-col gap-3 border border-white/30">
              <div className="text-blue-200 text-[12px]">TEMPO REAL</div>
              <div className="text-white font-bold text-lg">Mapa Vivo com 5 m de precisão</div>
              <div className="text-white/90 text-sm">Rastreamento contínuo por GPS, Wi-Fi e antenas celulares com atualização em milissegundos e fallback offline inteligente.</div>
            </div>
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-7 flex flex-col gap-3 border border-white/30">
              <div className="text-blue-200 text-[12px]">Filtros avançados</div>
              <div className="text-white font-bold text-lg">Filtros avançados</div>
              <div className="text-white/90 text-sm">Tipo de academia, faixa de preço, lotação, horários e amenities com ajustes instantâneos usando cache inteligente.</div>
            </div>
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-7 flex flex-col gap-3 border border-white/30">
              <div className="text-blue-200 text-[12px]">Rotas otimizadas</div>
              <div className="text-white font-bold text-lg">Rotas otimizadas</div>
              <div className="text-white/90 text-sm">Distância e tempo estimado para caminhada, bike, carro e transporte público com navegação turn-by-turn.</div>
            </div>
          </div>
        </div>
      </div>
